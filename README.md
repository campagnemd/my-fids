...
인천공항 공식 정기편 항공사 목록(여객·화물), 출발 API에서 확인한 실제 운항사, 코드쉐어 전용 항공사의 합집합을 관리합니다. 현재 135개 항공사 로고를 로컬 PNG로 저장했으며 FlightRadar24 로고를 우선 사용하고, FlightRadar24에 로고가 없는 항공사는 인천공항 공식 로고로 보완합니다.
